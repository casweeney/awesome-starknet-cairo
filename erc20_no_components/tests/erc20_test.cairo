...
use erc20_no_components::IERC20Dispatcher;
use erc20_no_components::IERC20DispatcherTrait;
...
fn test_token_constructor() {
    ...
    assert(token_name == "Cas Token", 'wrong token name');
    assert(token_symbol == "CST", 'wrong token symbol');
