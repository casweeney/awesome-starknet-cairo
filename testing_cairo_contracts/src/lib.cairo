...
pub trait IPizzaFactory<TContractState> {
    ...
    fn get_pepperoni_count(self: @TContractState) -> u32;
    fn get_pineapple_count(self: @TContractState) -> u32;
}
...
pub mod PizzaFactory {
    ...
    impl PizzaFactoryimpl of super::IPizzaFactory<ContractState> {
        ...
        fn get_pepperoni_count(self: @ContractState) -> u32 {
            self.pepperoni.read()
        }

        fn get_pineapple_count(self: @ContractState) -> u32 {
            self.pineapple.read()
        }
    }
